...
DOMAIN_UPPER = "ENTERPRISE_OPERATION"
MCP_SERVER_DIR = "enterprise-operation-mcp-server"
MCP_SERVER_NAME = "企业经营分析洞察"
REPORT_BANNER = "企业经营分析报告"
REPORT_TYPE = "enterprise_operation_analysis"
